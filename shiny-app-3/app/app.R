    ...
    if(input$storm_select == "February_2026_Noreaster"){
      tags$a(
        ...
        HTML(
          ...
          high winds, and temperature drops made for very hazardous conditions. Please note that snow pack impacted flood sensor readings. <u>Click here</u> to learn more about this storm in the 
      ...
      tags$a(
        ...
        HTML(
          ...
          exceeding the National Weather Service threshold for minor flooding. Please note that snow pack impacted flood sensor readings. 
